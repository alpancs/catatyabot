...
func TestPriceString12000(t *testing.T) {
	assertEqual(t, "12.000", Price(12000).String())
}
...
func TestPriceStringNeg12000(t *testing.T) {
	assertEqual(t, "-12.000", Price(-12000).String())
}

func TestPriceStringNeg123000(t *testing.T) {
	assertEqual(t, "-123.000", Price(-123000).String())
}
